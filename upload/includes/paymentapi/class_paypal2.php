...
/*==================================================================================*\
|| ################################################################################ ||
|| # Product Name: Paypal Payment API #2                         Version: 4.0.100 # ||
|| # License Type: Free License                                  $Revision: 145 $ # ||
|| # ---------------------------------------------------------------------------- # ||
|| # 																			  # ||
...
|| # 																			  # ||
|| # ----------------- "Paypal Payment API #2" IS FREE SOFTWARE ----------------- # ||
...
class vB_PaidSubscriptionMethod_paypal2 extends vB_PaidSubscriptionMethod
{
	...
	*/
	function generate_form_html($hash, $cost, $currency, $subinfo, $userinfo, $timeinfo)
	{
		...
		$show['notax'] = ($subinfo['options2'] & $this->settings['_SUBSCRIPTIONOPTIONS']['tax']) ? false : true;
		$show['recurring'] = ($this->supports_recurring AND $timeinfo['recurring']) ? true : false;
		$no_shipping = ($subinfo['options2'] & $this->settings['_SUBSCRIPTIONOPTIONS']['shipping1']) ? 0 : (($subinfo['options2'] & $this->settings['_SUBSCRIPTIONOPTIONS']['shipping2']) ? 2 : 1);
		...
		$templater = vB_Template::create('subscription_payment_paypal2');
...
|| # Version: 4.0.100
|| # $Revision: 168 $
|| # Released: $Date: 2010-07-27 17:06:59 +0300 (Tue, 27 Jul 2010) $
|| ########################################################################### ||
\*============================================================================*/
?>